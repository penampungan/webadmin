...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/product-unit/view','id'=>$model['RPT_TITLE_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/product-unit/update','id'=>$model['RPT_TITLE_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/basic/product-unit/delete','id'=>$model['RPT_TITLE_ID']]),
			'class'=>"btn btn-default btn-xs",
