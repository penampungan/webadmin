...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/basic/merchant-bank/create']);
		$options1 = ['value'=>$url,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/merchant-bank/view','id'=>$model['TYPE_PAY_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/merchant-bank/update','id'=>$model['TYPE_PAY_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/basic/merchant-bank/delete','id'=>$model['TYPE_PAY_ID']]),
			'class'=>"btn btn-default btn-xs",
