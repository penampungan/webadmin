...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/basic/industri/create']);
		$options1 = ['value'=>$url,
					'id'=>'industri-button-create',
					'data-pjax' => false,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/industri/view','id'=>$model['INDUSTRY_ID']]),
			'id'=>'industri-button-view',
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/industri/update','id'=>$model['INDUSTRY_ID']]),
			'id'=>'industri-button-update',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
		$icon1 = '
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/basic/industri/delete','id'=>$model['INDUSTRY_ID']]),
			'class'=>"btn btn-default btn-xs",
	...
	*/
	function tombolCreateGroup(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/basic/industri-group/create']);
		$options1 = ['value'=>$url,
					'id'=>'industri-button-create',
					'data-pjax' => false,
					'class'=>"btn btn-success btn-xs",
	...
	*/
	function tombolViewGroup($url, $model){
		$title1 = Yii::t('app',' View');
		$options1 = [
			'value'=>url::to(['/basic/industri-group/view','id'=>$model['INDUSTRY_GRP_ID']]),
			'id'=>'industri-button-view',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
	 ...
	 * BUTTON UPDATE
	*/
	function tombolUpdateGroup($url, $model){
		$title1 = Yii::t('app',' Edit');
		$options1 = [
			'value'=>url::to(['/basic/industri-group/update','id'=>$model['INDUSTRY_GRP_ID']]),
			'id'=>'industri-button-update',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
	 ...
	 * BUTTON Hapus
	*/
	function tombolDeleteGroup($url, $model){
		$title1 = Yii::t('app',' Hapus');
		$options1 = [
			'href'=>url::to(['/basic/industri-group/delete','id'=>$model['INDUSTRY_GRP_ID']]),
			'class'=>"btn btn-default btn-xs",
			'data'=>['confirm'=>'Apakah kamu yakin ingin mengapus data ini','method'=>'post',
			'class'=>"modal bootstrap-dialog type-danger fade size-normal in",		
			],    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
		$icon1 = '
	...
	function tombolKembali(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/basic/container-produk']);
		$options1 = [
					'id'=>'back-trafik',
					'class'=>"btn btn-xs",
