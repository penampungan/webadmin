...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/merchant-bank/view','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/merchant-bank/update','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/basic/merchant-bank/delete','id'=>$model['BANK_ID']]),
			'class'=>"btn btn-default btn-xs",
