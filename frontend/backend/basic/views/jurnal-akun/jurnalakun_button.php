...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/product-unit/view','id'=>$model['AKUN_CODE']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/basic/product-unit/update','id'=>$model['AKUN_CODE']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/basic/product-unit/delete','id'=>$model['AKUN_CODE']]),
			'class'=>"btn btn-default btn-xs",
