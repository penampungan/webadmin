...
$this->registerJs($this->render('jurnalstatus_script.js'),View::POS_READY);
echo $this->render('jurnalstatus_button'); //echo difinition
echo $this->render('jurnalstatus_modal'); //echo difinition
echo $this->render('jurnalstatus_colum'); //echo difinition


$bColor='rgb(51, 102, 153)';
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-bank fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Jurnal Status</b></div>';
        ...
        foreach(jurnalstatusAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
