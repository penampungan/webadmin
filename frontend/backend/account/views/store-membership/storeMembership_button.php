...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/account/store-membership/create']);
		$options1 = ['value'=>$url,
					'id'=>'storemembership-button-create',
					'data-pjax' => false,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/store-membership/view','id'=>$model['ID']]),
			'id'=>'storemembership-button-view',
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/store-membership/update','id'=>$model['ID']]),
			'id'=>'storemembership-button-update',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
		$icon1 = '
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/account/store-membership/delete','id'=>$model['ID']]),
			'class'=>"btn btn-default btn-xs",
	...
	function tombolKembali(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/account/container-store']);
		$options1 = [
					'id'=>'back-trafik',
					'class'=>"btn btn-xs",
