...
$this->registerJs($this->render('storekasir_script.js'),View::POS_READY);
echo $this->render('storekasir_button'); //echo difinition
echo $this->render('storekasir_modal'); //echo difinition
echo $this->render('storekasir_colum'); //echo difinition
