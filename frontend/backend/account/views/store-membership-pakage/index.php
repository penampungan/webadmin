...
use yii\web\View;	
$this->title = 'Store Membership Pakage';
$this->params['breadcrumbs'][] = ['label'=>'Store Controller', 'url' => ['/account/container-store']];
...
$this->registerJs($this->render('storeMembershipPakage_script.js'),View::POS_READY);
echo $this->render('storeMembershipPakage_button'); //echo difinition
echo $this->render('storeMembershipPakage_modal'); //echo difinition
echo $this->render('storeMembershipPakage_colum'); //echo difinition
...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        ...
        foreach(storeMemberShipPakageAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
