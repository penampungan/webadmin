...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/dompet-rekening/view','id'=>$model['ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/dompet-rekening/update','id'=>$model['ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/account/dompet-rekening/delete','id'=>$model['ID']]),
			'class'=>"btn btn-default btn-xs",
