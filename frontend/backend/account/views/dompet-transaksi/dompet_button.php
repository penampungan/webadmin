...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/store-membership-pakage/view','id'=>$model['TRANS_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/account/store-membership-pakage/update','id'=>$model['TRANS_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/account/store-membership-pakage/delete','id'=>$model['TRANS_ID']]),
			'class'=>"btn btn-default btn-xs",
