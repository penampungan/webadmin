...
echo $this->render('dompet_button'); //echo difinition
echo $this->render('dompet_modal'); //echo difinition
echo $this->render('dompet_colum'); //echo difinition

$bColor='rgb(51, 102, 153)';
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-home fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Tranaksi Dompet</b></div>';
        ...
        foreach(storekasirAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
