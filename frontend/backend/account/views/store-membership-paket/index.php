...
use yii\web\View;
$this->title = 'Store Membership Paket';
...
$this->registerJs($this->render('storeMembershipPaket_script.js'),View::POS_READY);
echo $this->render('storeMembershipPaket_button'); //echo difinition
echo $this->render('storeMembershipPaket_modal'); //echo difinition
echo $this->render('storeMembershipPaket_colum'); //echo difinition
