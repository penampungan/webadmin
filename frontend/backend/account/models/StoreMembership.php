...
class StoreMembership extends \yii\db\ActiveRecord
{
    ...
    public function getStorekasir()
    {
      return $this->hasOne(StoreKasir::className(),['KASIR_ID'=>'KASIR_ID']);
       
    }
    
    public function getKASIR_NM(){
        $result=$this->storekasir;
        return $result!=''?$result->KASIR_NM:'';
    }
}
