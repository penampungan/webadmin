...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        ...
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Jenis Transaksi</b></div>';
        ...
        foreach(ppobMasterKelompokAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
        ...
        $attDinamikField[]=[			
            ...
            'buttons' => [
                'edit' =>function($url, $model,$key){
                    return  tombolUpdateKelompok($url, $model);			
                },
                'view' =>function($url, $model,$key){
                    return  tombolViewKelompok($url, $model);			
                }
            ],
    ...
    $gvppobMasterHargaExist=GridView::widget([
        'id'=>'gv-harga-exist',
        'dataProvider' => $dataProviderKelompok,
        'filterModel' => $searchModelKelompok,
        ...
        'panel' => [
            ...
            'heading'=>$pageNm.'<div style="float:right;padding:0px 10px 0px 5px">'.tombolCreateKelompok().'</div>',  
            'type'=>'info',
