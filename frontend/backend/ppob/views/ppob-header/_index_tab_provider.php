...
$this->registerCss("
	...
	#gv-harga-update .kv-grid-container{
			height:400px
		}
");
...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        ...
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Master Provider</b></div>';
        ...
        foreach(ppobMasterProviderAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
        ...
        $attDinamikField[]=[			
            ...
            'buttons' => [
                'edit' =>function($url, $model,$key){
                    return  tombolUpdateProvider($url, $model);			
                },
                'view' =>function($url, $model,$key){
                    return  tombolViewProvider($url, $model);			
                }
            ],
    ...
    $gvppobMasterHargaUpdate=GridView::widget([
        'id'=>'gv-harga-update',
        'dataProvider' => $dataProviderProvider,
        'filterModel' => $searchModelProvider,
        ...
        'panel' => [
            ...
            'heading'=>$pageNm.'<div style="float:right;padding:0px 10px 0px 5px">'.tombolCreateProvider().'</div>',  
            'type'=>'success',
