...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        ...
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Jenis Paket</b></div>';
        ...
        foreach(ppobMasterHeaderAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
        ...
        $attDinamikField[]=[			
            ...
            'buttons' => [
                'edit' =>function($url, $model,$key){
                    return  tombolUpdateHedear($url, $model);			
                },
                'view' =>function($url, $model,$key){
                    return  tombolViewHedear($url, $model);			
                }
            ],
    ...
    $gvppobMasterHargaExist=GridView::widget([
        ...
        'panel' => [
            ...
            'heading'=>$pageNm.'<div style="float:right;padding:0px 10px 0px 5px">'.tombolCreateHedear().'</div>',  
            'type'=>'info',
