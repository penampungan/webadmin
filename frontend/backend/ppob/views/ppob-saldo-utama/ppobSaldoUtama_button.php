...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/ppob/ppob-saldo-utama/create']);
		$options1 = ['value'=>$url,
					'id'=>'ppobsaldoutama-button-create',
					'data-pjax' => false,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/ppob/ppob-saldo-utama/view','id'=>$model['ID']]),
			'id'=>'ppobsaldoutama-button-view',
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/ppob/ppob-saldo-utama/update','id'=>$model['ID']]),
			'id'=>'ppobsaldoutama-button-update',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
		$icon1 = '
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/ppob/ppob-saldo-utama/delete','id'=>$model['ID']]),
			'class'=>"btn btn-default btn-xs",
