...
$this->registerJs($this->render('ppobSaldoUtama_script.js'),View::POS_READY);
echo $this->render('ppobSaldoUtama_button'); //echo difinition
echo $this->render('ppobSaldoUtama_modal'); //echo difinition
echo $this->render('ppobSaldoUtama_colum'); //echo difinition

$bColor='rgb(51, 102, 153)';
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-usd fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Member Saldo</b></div>';
        ...
        foreach(ppobSaldoUtamaAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
