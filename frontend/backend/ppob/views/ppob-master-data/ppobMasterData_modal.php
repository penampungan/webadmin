...
");
	...
	*/
	Modal::begin([
		//'id' => 'sync_save',
		'id' => 'ppobmasterdata-button-create-modal',
		'header' => '
		...
		echo "<div id='ppobmasterdata-button-create-content'></div>";
	Modal::end();
	...
	*/
	Modal::begin([
		'id' => 'ppobmasterdata-button-view-modal',
		'header' => '
			<span class="fa-stack fa-xs">																	
				<i class="fa fa-circle fa-stack-2x " style="color:red"></i>
		...
		echo "<div id='ppobmasterdata-button-view-content'></div>";
	Modal::end();
	...
	*/
	Modal::begin([
		//'id' => 'sync_save',
		'id' => 'ppobmasterdata-button-update-modal',
		'header' => '
			<span class="fa-stack fa-xs">																	
				<i class="fa fa-circle fa-stack-2x " style="color:red"></i>
		...
		echo "<div id='ppobmasterdata-button-update-content'></div>";
	Modal::end();
