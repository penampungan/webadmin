...
$this->registerJs($this->render('ppobMasterKtg_script.js'),View::POS_READY);
echo $this->render('ppobMasterKtg_button'); //echo difinition
echo $this->render('ppobMasterKtg_modal'); //echo difinition
echo $this->render('ppobMasterKtg_colum'); //echo difinition
$this->title = 'PPOB-Master Kategori';

$bColor='rgb(51, 102, 153)';
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-list fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data PPOB Master Kategori</b></div>';
        ...
        foreach(ppobMasteKtgAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
    ...
    $gvppobMasterKtg=GridView::widget([
        'id'=>'gv-data-industri',
