...
");
	...
	*/
	Modal::begin([
		//'id' => 'sync_save',
		'id' => 'ppobmasterktg-button-create-modal',
		'header' => '
		...
		echo "<div id='ppobmasterktg-button-create-content'></div>";
	Modal::end();
	...
	*/
	Modal::begin([
		'id' => 'ppobmasterktg-button-view-modal',
		'header' => '
			<span class="fa-stack fa-xs">																	
				<i class="fa fa-circle fa-stack-2x " style="color:red"></i>
		...
		echo "<div id='ppobmasterktg-button-view-content'></div>";
	Modal::end();
	...
	*/
	Modal::begin([
		//'id' => 'sync_save',
		'id' => 'ppobmasterktg-button-update-modal',
		'header' => '
			<span class="fa-stack fa-xs">																	
				<i class="fa fa-circle fa-stack-2x " style="color:red"></i>
		...
		echo "<div id='ppobmasterktg-button-update-content'></div>";
	Modal::end();
