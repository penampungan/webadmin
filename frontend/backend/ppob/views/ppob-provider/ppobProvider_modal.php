...
");
	...
	*/
	Modal::begin([
		...
		echo "<div id='ppobprovider-button-create-content'></div>";
	Modal::end();
	...
	*/
	Modal::begin([
		//'id' => 'sync_save',
		'id' => 'ppobprovider-button-update-modal',
		'header' => '
			<span class="fa-stack fa-xs">																	
				<i class="fa fa-circle fa-stack-2x " style="color:red"></i>
				<i class="fa fa-pencil fa-stack-1x" style="color:#fbfbfb"></i>
			</span><b> UBAH DATA PROVIDER</b>
		',	
		'size' => 'modal-md',
		'options' => ['class'=>'slide'],
		'headerOptions'=>[
		...
		echo "<div id='ppobprovider-button-update-content'></div>";
	Modal::end();
