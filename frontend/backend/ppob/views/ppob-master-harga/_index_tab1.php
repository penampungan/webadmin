...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        ...
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Master Harga</b></div>';
        ...
        foreach(ppobMasterHargaAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
        ...
        $attDinamikField[]=[			
            ...
            'buttons' => [
                'edit' =>function($url, $model,$key){
                    return  tombolUpdateharga($url, $model);			
                }
            ],
