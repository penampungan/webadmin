...
$this->title = 'PPOB-Master Harga Update';

echo $this->render('ppobMasterHargaUpdate_colum'); //echo difinition
$bColor='rgb(51, 102, 153)';
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-money fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Master Harga Update</b></div>';
        ...
        foreach(ppobMasterHargaUpdateAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
