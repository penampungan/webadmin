...
/**
 * PpobSaldoUtamaSearch represents the model behind the search form of `frontend\backend\ppob\models\PpobSaldoUtama`.
 */
class PpobSaldoUtamaSearch extends PpobSaldoUtama
{
    /**
     * @inheritdoc
     */
