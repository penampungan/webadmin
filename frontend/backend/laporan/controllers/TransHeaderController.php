...
/**
 * TransHeaderController implements the CRUD actions for TransPenjualanHeader model.
 */
class TransHeaderController extends Controller
{
    ...
    /**
     * Lists all TransPenjualanHeader models.
     * @return mixed
     */
    ...
    /**
     * Displays a single TransPenjualanHeader model.
     * @param string $ID
    ...
    /**
     * Creates a new TransPenjualanHeader model.
     * If creation is successful, the browser will be redirected to the 'view' page.
     * @return mixed
     */
    public function actionCreate()
    {
        $model = new TransPenjualanHeader();
    ...
    /**
     * Updates an existing TransPenjualanHeader model.
    ...
    /**
     * Deletes an existing TransPenjualanHeader model.
    ...
    /**
     * Finds the TransPenjualanHeader model based on its primary key value.
     ...
     * @param integer $YEAR_AT
     * @param integer $MONTH_AT
     * @return TransPenjualanHeader the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($ID, $STORE_ID, $TRANS_ID, $YEAR_AT, $MONTH_AT)
    {
        if (($model = TransPenjualanHeader::findOne(['ID' => $ID, 'STORE_ID' => $STORE_ID, 'TRANS_ID' => $TRANS_ID, 'YEAR_AT' => $YEAR_AT, 'MONTH_AT' => $MONTH_AT])) !== null) {
            return $model;
        } else {
