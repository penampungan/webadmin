...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg/view','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg/update','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/sistem/user-kg/delete','id'=>$model['BANK_ID']]),
			'class'=>"btn btn-default btn-xs",
