...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/sistem/user-kg-profile/create']);
		$options1 = ['value'=>$url,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg-profile/view','ID'=>$model['ID'],'ACCESS_ID' => $model['ACCESS_ID'], 'YEAR_AT' => $model['YEAR_AT'], 'MONTH_AT' => $model['MONTH_AT']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg-profile/update','ID'=>$model['ID'],'ACCESS_ID' => $model['ACCESS_ID'], 'YEAR_AT' => $model['YEAR_AT'], 'MONTH_AT' => $model['MONTH_AT']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/sistem/user-kg-profile/delete','ID'=>$model['ID'],'ACCESS_ID' => $model['ACCESS_ID'], 'YEAR_AT' => $model['YEAR_AT'], 'MONTH_AT' => $model['MONTH_AT']]),
			'class'=>"btn btn-default btn-xs",
