...
use yii\base\DynamicModel;
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg-profile/view','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/user-kg-profile/update','id'=>$model['BANK_ID']]),
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/sistem/user-kg-profile/delete','id'=>$model['BANK_ID']]),
			'class'=>"btn btn-default btn-xs",
