...
$this->registerJs($this->render('cronjob_script.js'),View::POS_READY);
...
$pageNm='<span class="fa-stack fa-xs text-left" style="float:left">
        <b class="fa fa-tasks fa-stack-2x" style="color:#000000"></b>
        </span> <div style="float:left;padding:10px 20px 0px 5px"><b> Data Croonjob</b></div>';
        ...
        foreach(cronjobAryColumn() as $key =>$value[]){			
            $attDinamikField[]=[
