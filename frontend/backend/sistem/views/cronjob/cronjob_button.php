...
use yii\base\DynamicModel;
	...
	*/
	function tombolCreate(){
		$title= Yii::t('app','');
		$url = Url::toRoute(['/sistem/cronjob/create']);
		$options1 = ['value'=>$url,
					'id'=>'cronjob-button-create',
					'data-pjax' => false,
	...
	*/
	function tombolView($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/cronjob/view','id'=>$model['ID']]),
			'id'=>'cronjob-button-view',
	...
	*/
	function tombolUpdate($url, $model){
		...
		$options1 = [
			'value'=>url::to(['/sistem/cronjob/update','id'=>$model['ID']]),
			'id'=>'cronjob-button-update',
			'class'=>"btn btn-default btn-xs",    
			'style'=>['text-align'=>'left','width'=>'100%', 'height'=>'25px','border'=> 'none'],
		];
		$icon1 = '
	...
	*/
	function tombolDelete($url, $model){
		...
		$options1 = [
			'href'=>url::to(['/sistem/cronjob/delete','id'=>$model['ID']]),
			'class'=>"btn btn-default btn-xs",
